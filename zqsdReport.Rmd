...
```{r wordcloudloop, fig.height = 8, fig.width = 8, dpi=200}
...
temp <- temp[nchar(temp$temp) > 3,]
  ...
  par(mar=rep(0, 4))
  plot.new()
  text(x=0.5, y=0.5, unick, col=jColors[unick],cex=2)
  
    wordcloud(temp$temp,temp$Freq,max.words =100, main="Title" 
...
### Word Cloud (last week - top 500)
```{r wordcloud, fig.height = 10, fig.width = 10, dpi=200}
